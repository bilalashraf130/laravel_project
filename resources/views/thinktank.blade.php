...
<form method="POST" id="user_activity_feed" class="form-style">
    @csrf
    <h4>Add Your ThinkTank!</h4>
    <ul>
        <li>
            <input type="text" name="Thinking" id="Thinking" class="field-style field-split align-left" placeholder="ThinkTank" />

        </li>
        <li>
            <input type="text" name="data" id="data" class="field-style field-split align-left" placeholder="data " />
        </li>
        <li>
            <input type="text" name="information" id="information" class="field-style field-full align-none" placeholder="information" />
        </li>
        <li>
            <button class="btn-narrative" type="submit" > Submit</button>
            <a href="{{url('/add-thinktankcount')}}">Add count</a>
        </li>
